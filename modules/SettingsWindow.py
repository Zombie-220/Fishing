...
class SettingsWindow(QtWidgets.QMainWindow):
    ...
    def __init__(self, parent: QtWidgets.QMainWindow):
        ...
        self.setFixedSize(560, 175)
        self.move(parent.pos().x() - self.width()//2, parent.height() + 10)
        ...
        grid.addWidget(self.__entry_rodKey, 0, 1, 1, 4)
        ...
        grid.addWidget(label_mealTimer, 1, 3)
        grid.addWidget(self.__entry_mealTimer, 1, 4)
        ...
        grid.addWidget(label_potionTimer, 2, 3)
        grid.addWidget(self.__entry_potionTimer, 2, 4)
        ...
        grid.addWidget(label_seaChoise, 3, 0)
        grid.addWidget(self.__sea_combo, 3, 1, 1, 4)
